...
![Flight path with an average (obfuscation) distance of 100 meters and maximum transmit range of 1000 meters.]([http://url/to/img.png](https://github.com/MSchotsman/OLD-RID/blob/main/obfuscated.png))
