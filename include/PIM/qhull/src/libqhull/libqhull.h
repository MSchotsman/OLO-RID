...
/* MathWorks specific Windows defines  */
#if !defined(_EXPORTING) && defined(_WIN32)
...
#define qh qh_qh->
extern VAR_DECLSPEC qhT *qh_qh;     /* allocated in global.c */
#else
#define qh qh_qh.
extern VAR_DECLSPEC qhT qh_qh;
#endif

#define qh_buflen  4000
...
*/
  ...
  char mwerrmsg[qh_buflen];      /* Victoria added this to pass error message to qhullmx.c MathWorks */
...
/* MathWorks specific function */
void    qh_init_mwerrmsg (void);
/* End MathWorks specific function */
...
/* The MathWorks, Inc. added this lines to manage error messages */
#include <stdarg.h> 
int mwprintf( FILE *stream, const char *format, ... ); 
void mwvprintf( FILE *stream, const char *format, va_list arg); 
  
#define fprintf mwprintf 
#define vfprintf mwvprintf 
/* end added lines */
