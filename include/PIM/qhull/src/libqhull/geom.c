...
pointT *qh_getcenter(setT *vertices) {
  ...
  /* Begin Change */
  center= (pointT *)qh_memalloc((size_t)(qh normal_size));
  /* End Change */
...
pointT *qh_getcentrum(facetT *facet) {
  ...
  /* MathWorks Changes 12-17-2019 - Siju Thomas */
  /* Begin Change */
  qh_memfree(point, (size_t)(qh normal_size));
  /* End Change */
...
pointT *qh_projectpoint(pointT *point, facetT *facet, realT dist) {
  ...
  /* MathWorks Changes 12-17-2019 - Siju Thomas */
  /* Begin Change */
  qh_memalloc_((size_t)normsize, freelistp, newpoint, pointT);
  /* End Change */
  np= newpoint;
  normal= facet->normal;
  for (k=qh hull_dim; k--; )
...
void qh_setfacetplane(facetT *facet) {
  ...
  if (!facet->normal)
    /* MathWorks Changes 12-17-2019 - Siju Thomas */
    /* Begin Change */
    qh_memalloc_((size_t)normsize, freelistp, facet->normal, coordT);
    /* End Change */
