  ...
  if (insize <= qhmem.LASTsize) {
    ...
    if ((object= *freelistp)) {
      ...
      *freelistp= *((void **)*freelistp);  /* replace freelist with next object */
      ...
      /* Begin Change */
      if (qhmem.IStracing >= 5)
          qh_fprintf(qhmem.ferr, 8140, "qh_mem %p n %8d alloc short: %zu bytes (tot %d cnt %d)\n", object, n, outsize, qhmem.totshort, qhmem.cntshort+qhmem.cntquick-qhmem.freeshort);
      /* End Change */
#endif
      return object;
    }
    ...
    /* MathWorks Changes 12-17-2019 - Siju Thomas */
    /* Begin Change */
    if (!(object= qh_malloc((size_t)outsize)) || qhmem.totlong > 2.14e9) {
...
/* MathWorks Changes 12-17-2019 - Siju Thomas */
/* Begin Change */
void qh_memfree(void *object, size_t insize) {
  void **freelistp;
  int idx;
  size_t outsize;
/* End Change */
...
/* End Change */
  ...
  if (qhmem.IStracing >= 5)
    /* MathWorks Changes 12-17-2019 - Siju Thomas */
    /* Begin Change */
    qh_fprintf(qhmem.ferr, 8060, "qh_mem %p n %8d alloc long: %zu bytes (tot %d cnt %d)\n", object, qhmem.cntlong+qhmem.freelong, insize, qhmem.totlong, qhmem.cntlong-qhmem.freelong);
    /* End Change */
  return object;
}
...
/* End Change */
  ...
  if (qhmem.IStracing >= 5)
    /* MathWorks Changes 12-17-2019 - Siju Thomas */
    /* Begin Change */
    qh_fprintf(qhmem.ferr, 8061, "qh_mem %p n %8d free long: %zu bytes (tot %d cnt %d)\n", object, qhmem.cntlong+qhmem.freelong, insize, qhmem.totlong, qhmem.cntlong-qhmem.freelong);
    /* End Change */
}
