...
void qh_projectinput(void) {
  ...
  /* Begin Change */
  project= (signed char*)qh_memalloc((size_t)size);
  /* End Change */
...
boolT qh_sharpnewfacets() {
  ...
  /* MathWorks Changes 12-17-2019 - Siju Thomas */
  /* Begin Change */
  quadrant= (int*)qh_memalloc((size_t)(qh hull_dim) * sizeof(int));
  /* End Change */
  ...
  /* MathWorks Changes 12-17-2019 - Siju Thomas */
  /* Begin Change */
  qh_memfree( quadrant, (size_t)(qh hull_dim) * sizeof(int));
  /* End Change */
...
pointT *qh_voronoi_center(int dim, setT *points) {
  ...
  /* MathWorks Changes 12-17-2019 - Siju Thomas */
  /* Begin Change */
  pointT *center= (pointT*)qh_memalloc((size_t)(qh center_size));
  /* End Change */
  setT *simplex;
